    ...
    <div className="p-6">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                ...
                {currentPlan?.id === 'free' ? 'Plan Information' : 'Billing Information'}
              </CardTitle>
            </CardHeader>
            <CardContent>
              {currentPlan?.id === 'free' ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Free Plan - No Billing Required</h3>
                  <p className="text-gray-600 mb-4">
                    You're on the Free plan with no monthly charges. Only pay when you receive bookings.
                  </p>
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div className="flex items-center justify-center space-x-2">
                      <span className="text-green-800 font-medium">Transaction Fee: 10% per booking</span>
                    </div>
                ...
                <>
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-gray-700">
                          {currentPlan?.id === 'starter' ? '5%' :
                           currentPlan?.id === 'professional' ? '3%' : '2%'} per booking
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    {currentPlan?.id === 'free' ? '10%' : 
                     currentPlan?.id === 'starter' ? '5%' :
                     currentPlan?.id === 'professional' ? '3%' : '2%'} platform fee
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <div className="space-y-6">
          ...
          {currentPlan?.status === 'active' && currentPlan?.id !== 'free' && (
